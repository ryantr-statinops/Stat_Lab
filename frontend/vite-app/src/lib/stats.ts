/**
 * Helper thống kê phía client — bản sao của frontend/next-app/lib/stats.ts.
 * Giữ cùng quy ước (giá trị trùng cạnh trên của bin cuối rơi vào bin cuối)
 * để hai frontend cho kết quả nhất quán.
 */
