...
| 3 | [`vite-frontend-proposal.md`](vite-frontend-proposal.md) | **Frontend thứ hai** React18+TS+Vite :5173 — full mirror của next-app (5 trang), HTTP bằng fetch thuần, so sánh hai paradigm | ✅ ĐÃ TRIỂN KHAI XONG | API không đổi; độc lập với proposal #2 |
